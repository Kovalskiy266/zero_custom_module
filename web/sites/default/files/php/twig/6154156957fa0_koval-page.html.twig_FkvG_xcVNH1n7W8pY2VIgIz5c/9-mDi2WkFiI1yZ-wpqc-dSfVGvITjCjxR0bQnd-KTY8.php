...
<div class=\"cats-table-wrapper\">";
        // line 3
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["cats"] ?? null), 3, $this->source), "html", null, true);
        echo "</div>
<div id=\"overlay\">
